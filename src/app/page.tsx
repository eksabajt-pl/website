...
export default function Home() {
  return (
    <>
      <Header />
      <main className="font-sans gap-8 p-8 flex flex-row gap-4 min-h-[80vh] items-center justify-center">
        <div className="flex-col items-center flex gap-8">
          <DotLottieReact autoplay loop src="https://lottie.host/b4014534-9c95-4c41-b369-127a2dc69f1d/g50Lzd41Ky.json"/>

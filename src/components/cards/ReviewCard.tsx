	...
	return (
		<TooltipProvider>
			<Tooltip>
				...
				<TooltipContent>{t("tooltip.verified")}</TooltipContent>
			</Tooltip>
		</TooltipProvider>
	);
};
	...
	return (
		<TooltipProvider>
			<Tooltip>
				...
				<TooltipContent>{t("tooltip.rejected")}</TooltipContent>
			</Tooltip>
		</TooltipProvider>
	);
};
	...
	return (
		<TooltipProvider>
			<Tooltip>
				...
				<TooltipContent>{t("tooltip.pending")}</TooltipContent>
			</Tooltip>
		</TooltipProvider>
	);
};
...
export default function ReviewCard({
	...
	return (
		<Card
			className={twMerge(
				"flex flex-col p-4 gap-2 overflow-hidden ",
				className
			)}>

	...
	return (
		<CustomCard
			...
			<button
				...
				className="z-1 text-sm flex-row font-bold p-1 flex justify-center items-center text-white gap-2 bg-green-600 mx-4 cursor-pointer rounded-lg hover:scale-102 hover:bg-green-700 transition-all duration-200">
